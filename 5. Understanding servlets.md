...
- 동작 과정
    ...
    ![Chapter 5 Picture 1](md-images/Chapter%205%20Picture%201.jpg)
...
- 서블릿 요청하기
    ...
    3. 웹 브라우저에서 요청하면 이클립스 콘솔에 각각의 메서드가 호출되면서 메시지 출력
        ...
        ![Chapter 5 Picture 2](md-images/Chapter%205%20Picture%202.png)
...
- 두 번째 서블릿 실행 결과
    ...
    ![Chapter 5 Picture 3](md-images/Chapter%205%20Picture%203.png)
...
- 동작 과정
    ...
    <img src="md-images/Chapter%205%20Picture%204.png" alt="Chapter 5 Picture 4" style="zoom:22%;" />
...
- 적용 결과
    ...
    - 실행 결과
        ...
        ![Chapter 5 Picture 5](md-images/Chapter%205%20Picture%205.png)
