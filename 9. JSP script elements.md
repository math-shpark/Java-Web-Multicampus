...
- 실행 결과
    ...
    ![Chapter 9 Picture 1.png](./img/Chapter_9_Picture_1.png)
...
- 실습 1 결과
    - 입력값 : ID - hong / pw - 1234
        ...
        ![Chapter 9 Picture 2.png](./img/Chapter_9_Picture_2.png)
...
- 실습 2 결과
    1. 아이디를 정상적으로 입력한 경우
        - 입력값 : id - hong / pw - 1234
            ...
            ![Chapter_9_Picture_3](./img/Chapter_9_Picture_3.png)
        
    2. 아이디를 입력하지 않은 경우
       
        ![Chapter 9 Picture 4.png](./img/Chapter_9_Picture_4.png)
...
- 실습 3 결과
    1. admin으로 로그인 한 경우
        - 입력값 : ID - admin / PW - 1234
            ...
            ![Chapter 9 Picture 5](./img/Chapter_9_Picture_5.png)
        
    2. 다른 ID로 로그인 한 경우
        - 입력값 : ID - kim / PW - 1234
          
            ![Chapter 9 Picture 6](./img/Chapter_9_Picture_6.png)
...
- 실습 결과
    1. 최초 서블릿 요청
        ...
        ![Chapter 9 Picture 7](./img/Chapter_9_Picture_7.png)
        
    2. 첫번째 페이지로 이동하기 클릭
       
        ![Chapter 9 Picture 8](./img/Chapter_9_Picture_8.png)
        
        - 서블릿에서 바인딩한 name이 출력됨
    3. 두번째 페이지로 이동 클릭
       
        ![Chapter 9 Picture 9](./img/Chapter_9_Picture_9.png)
...
- 실습 결과
    1. 첫 번째 브라우저에서 요청(appTest1.jsp)
        ...
        ![Chapter 9 Picture 10](./img/Chapter_9_Picture_10.png)
        
    2. 두 번째 브라우저에 요청(appTest2.jsp)
        1. 동일한 브라우저에서 요청 시
           
            ![Chapter 9 Picture 11](./img/Chapter_9_Picture_11.png)
            
            - session과 application에 접근 가능
        2. 다른 브라우저에서 요청 시
           
            ![Chapter 9 Picture 12](./img/Chapter_9_Picture_12.png)
...
- 실습 결과
    ...
    ![Chapter 9 Picture 13](./img/Chapter_9_Picture_13.png)
...
- 실습 결과
    1. 이름과 나이 전송
        ...
        ![Chapter 9 Picture 14](./img/Chapter_9_Picture_14.png)
        
    2. 표현식과 out 내장 객체로 출력
       
        ![Chapter 9 Picture 15](./img/Chapter_9_Picture_15.png)
...
- 실습 결과
    1. 정상 데이터 입력한 경우
        1. 입력
            ...
            ![Chapter 9 Picture 16](./img/Chapter_9_Picture_16.png)
            
        2. 출력
           
            ![Chapter 9 Picture 17](./img/Chapter_9_Picture_17.png)
        
    2. 잘못된 데이터 입력한 경우
        1. 입력
           
            ![Chapter 9 Picture 18](./img/Chapter_9_Picture_18.png)
            
        2. 출력
           
            ![Chapter 9 Picture 19](./img/Chapter_9_Picture_19.png)
...
- 실습 결과
    1. 잘못된 주소를 입력한 경우
        ...
        ![Chapter 9 Picture 20](./img/Chapter_9_Picture_20.png)
        
    2. 실행 중 예외를 발생시키는 페이지를 요청한 경우
       
        ![Chapter 9 Picture 21](./img/Chapter_9_Picture_21.png)
...
- 실습 결과
    ...
    ![Chapter 9 Picture 22](./img/Chapter_9_Picture_22.png)
...
- 실습 결과
    1. 조회할 이름을 입력한 후 요청
        ...
        ![Chapter 9 Picture 23](./img/Chapter_9_Picture_23.png)
        
    2. 이름을 입력하지 않고 요청
       
        ![Chapter 9 Picture 24](./img/Chapter_9_Picture_24.png)
